...
class NumberExtractorTest {
    ...
    void extractNumbersContainCustomDelimiter() {
        ...
        List<Integer> result = numberExtractor.extractNumbers(expression, true, "^^");
    ...
    void extractNumbersContainDefaultDelimiter() {
        String input = "1,2;3";
        List<Integer> result = numberExtractor.extractNumbers(input, false, "");
        assertThat(List.of(1,2,3)).isEqualTo(result);
    }
    ...
    void failExtractNumbersContainInvalidNumber() {
        String input = "1,2;a";
        assertThatThrownBy(() -> numberExtractor.extractNumbers(input, false, ""))
    ...
    void failExtractNumbersContainInvalidNumberUsedCustomDelimiter() {
        String input = "1#2#a";
        assertThatThrownBy(() -> numberExtractor.extractNumbers(input, true, "#"))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("연산식에 유효하지 않은 숫자가 포함되어 있습니다.");
    }
