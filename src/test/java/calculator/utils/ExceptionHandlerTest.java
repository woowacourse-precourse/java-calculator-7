...
class ExceptionHandlerTest {
    ...
    @ValueSource(chars = {'{', '}', '|'})
    void checkIncorrectCustomDelimGenerateInputThrowException(char elem) {
        assertThatThrownBy(() -> exceptionHandler.checkIncorrectCustomDelimGenerateInput(elem)).isInstanceOf(
    ...
    @ValueSource(chars = {'/', '\\', 'n'})
    void checkIncorrectCustomDelimGenerateInputNotThrowException(char elem) {
        assertThatCode(() -> exceptionHandler.checkIncorrectCustomDelimGenerateInput(elem)).doesNotThrowAnyException();
    }
