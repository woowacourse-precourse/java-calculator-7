...
class FormatValidatorTest {
    ...
    void 숫자를_나타내는_문자열이_0으로_시작하면_예외_발생(String a, String b) {
        assertThatThrownBy(() -> formatValidator.validateNoLeadingZero(Arrays.asList(a, b)))
                .isExactlyInstanceOf(IllegalArgumentException.class);
    }
    ...
    void 숫자를_나타내는_문자열이_0으로_시작하지_않으면_검증_통과(String a, String b) {
        assertThatCode(() -> formatValidator.validateNoLeadingZero(Arrays.asList(a, b))).doesNotThrowAnyException();
    }
}