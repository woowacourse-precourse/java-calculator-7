...
public class Input {
    ...
    private static boolean validateGeneralUserInput(String input) {
    ...
    private static boolean validateCustomUserInput(String input) {
    ...
    private static boolean validateCustomFrontAndCharacter(String input) {
        if (input.length() > 1) {
    ...
    //사용자가 입력한 기본 구분자 검증
    private static boolean validateSeparator(String input) {
    ...
    //사용자가 입력한 커스텀 구분자 검증
    private static boolean validateSeparator(String input, char customSeparator) {
    ...
    private static boolean validateIncludeSeparator(char inputChar) {
    ...
    private static boolean validateIncludeSeparator(char inputChar, char customSeparator) {
        if (!Character.isDigit(inputChar)) {
    ...
    private static boolean validateGeneralSequenceSeparator(String input) {
        for (char inputChar : input.toCharArray()) {
            if (input.indexOf(inputChar) != (input.length() - 1) && !Character.isDigit(inputChar)) {
    ...
    private static boolean validateCustomSequenceSeparator(String input) {
        for (int i = 5; i < input.length(); i++) {
            char inputChar = input.charAt(i);
    ...
    private static boolean validateLastSeparator(String input) {
