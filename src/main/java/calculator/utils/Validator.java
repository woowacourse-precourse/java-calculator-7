...
public class Validator {
    ...
    public static final String POSITIVE_NUMBER_EXCEPTION_MESSAGE = "양수이여야 합니다.";
    public static final String CUSTOM_SEPARATOR_EXCEPTION_MESSAGE = "커스텀 구분자는 한 글자여야 합니다.";
    public static final String START_POSITIVE_NUMBER_EXCEPTION_MESSAGE = "양수부터 입력하셔야 합니다.";
