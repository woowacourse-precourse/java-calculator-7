...
import static calculator.Constants.CUSTOM_DELIMITER_END_CHAR;
...
public class CustomDelimiterDefinitionRemover {
    public String eraseCustomDelimiterDefinition(String inputNumber) {
        return inputNumber.substring(inputNumber.lastIndexOf(CUSTOM_DELIMITER_END_CHAR) + START_INDEX_AFTER_NEWLINE);
    }
}
