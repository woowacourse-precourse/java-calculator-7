...
import static calculator.domain.common.Message.잘못된_커스텀_구분자_형식입니다;
import static calculator.domain.common.Token.CUSTOM_TOKEN_PREFIX;
import static calculator.domain.common.Token.NEW_LINE;
