...
public class ErrorView {
    ...
    private static final String DELIMITER_NUMERIC_ERROR_MESSAGE = "[ERROR] 커스텀 구분자는 문자로 이루어져야 합니다.";
    ...
    public static void delimiterNumericError() {
        System.out.println(DELIMITER_NUMERIC_ERROR_MESSAGE);
    }
}
