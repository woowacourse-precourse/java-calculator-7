...
public class CalculatorServiceImpl implements CalculatorService {
    ...
    public List<String> findValidNumber(String userInput) {
        ...
        String changedUserInput = userInput.substring(
                userInput.lastIndexOf(END_CUSTOM_DELIMITER) + 2,
                userInput.length());
    ...
    private String findCustomDelimiter(String userInput) {
        if (userInput.contains(START_CUSTOM_DELIMITER) && userInput.contains(
