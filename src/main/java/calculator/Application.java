...
public class Application {
    ...
    private static int getTotalSum(String inputText, boolean isCustomSeparator) {
        ...
        if (isCustomSeparator) {
            String separator = inputText.substring(2, 3);
            splitText = inputText.substring(5).split(separator);
        } else {
