...
public enum ErrorMessage {
	...
	INVALID_CUSTOM_DELIMITER_FORMAT("커스텀 구분자는 맨 앞부분에서만 '//' '\\n'을 사용하여 지정할 수 있습니다. ex)//+\\n1+2+3"),
	...
	INVALID_NUMBER_FORMAT("구분자 사이에는 숫자만 사용할 수 있습니다."),
	START_WITH_DELIMITER("구분자로 시작할 수 없습니다."),
	END_WITH_DELIMITER("구분자로 끝날 수 없습니다."),
	USE_CONTINUOUS_DELIMITER("연속된 구분자는 사용할 수 없습니다."),
	...
	OVER_FLOW_SUM("덧셈의 결과가 정해진 범위를 초과했습니다.");
