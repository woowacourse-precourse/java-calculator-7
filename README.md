...
## 📝 기능 구현 목록
- [ ] [1. 입력](#1-입력)
    - [ ] [1.1 사용자 입력 처리](#11-사용자-입력-처리)
    - [ ] [1.2 문자열 유효성 검사](#12-빈-문자열-검사)
- [ ] [2. 애플리케이션 로직](#2-애플리케이션-로직)
    - [ ] [2.1 구분자 판별 기능](#21-구분자-판별-기능)
...
> - 입력 : 문자열 (예 : `"//;\n1;2;3"` 또는 `"1,2:3"`)
> - 반환 : 문자 (`,`, `:`, `커스텀 구분자`)
> - 기능 : 입력된 문자열을 분석하여 기본 구분자(쉼표 `,`, 콜론 `:`) 또는 커스텀 구분자를 판별하고, 사용할 구분자를 결정한다. 구분자가 요구 형식을 따르지 않는 경우 `IllegalArgumentException` 예외를 발생시킨다.
>
> #### 2.2 구분자 처리 기능
> - 입력 : 문자열 (예: `"//;\n1;2;3"` 또는 `"1,2:3"`)
